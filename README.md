...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jautlks.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jautlks.containers.anotherwebservice.com/
...
```
git clone git@github.com:darkwalker099/container-jautlks.git
cd container-jautlks
```
...
```
docker attach container-jautlks
```
